...
function Navbar() {
  ...
  return (
    <header className="container mx-auto z-10 shadow-md px-4 py-6 flex justify-between items-center bg-gray-800">
      <Link to={"/"}>
        <div className="flex items-center space-x-4">
          ...
          <span className="font-bold text-white text-xl">CHAIN CONNECT</span>
        </div>
      </Link>
